...
# Single node cluster
Often, you'll want to find the cheapest hosting providers (Hetzner is a common choice), who do not provider a managed Kubernetes offering. In that case, you can still get all the benefits of Canine, but you'll have to install a K3s instance. Thsi is recommended to be used in staging, or low traffic environments.
